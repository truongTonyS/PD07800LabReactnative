...
const ListUser = ({ navigation }) => {
  ...
  return (
    <ScrollView>
      <TouchableOpacity style={styles.buttonNew} onPress={() => navigation.navigate('AddUser')}>
          ...
          data.map((item, index) => (
            <View style={styles.container} key={index}>
              ...
              <View style={styles.containerButton}>
                ...
                <TouchableOpacity style={styles.button}>
                  <Text style={styles.buttonText} onPress={() => handelDelete(item.id)}>Delete</Text>
                </TouchableOpacity>
              </View>
            </View>
          ))
      ...
      <Modal visible={openDialog} transparent={true}>
        <UpdateModel
          ...
          getAPI={getAPI}
          selectedUser={selectedUser} // Thêm prop selectedUser
        />
      </Modal>
    </ScrollView>
  );
